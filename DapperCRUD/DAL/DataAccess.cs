...
namespace DapperCRUD.DAL
{
    public class DataAccess
    {
        ...
        public IEnumerable<Employee> GetEmpInfo(int procid, Employee Models)
        {
            ...
            parameters.Add("@UserPassword", Models.UserPassword ?? string.Empty);
        ...
        {
            var Query = @"Select userid, UserName,RoleId from Employee  where userid='" + M.userid + "' and UserPassword='" + M.password + "'";
